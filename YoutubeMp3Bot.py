...
def start(client, message):
    Sumaanaryal = f'👋 𝗛𝗲𝗹𝗹𝗼 @{message.from_user.username}\n\n𝗜 𝗔𝗺 🎸Youtube Mp3 Bot[🎶](https://telegra.ph/file/6cb884fe1cb943ec12df1.mp4)\n\n𝗦𝗲𝗻𝗱 𝗧𝗵𝗲 𝗡𝗮𝗺𝗲 𝗢𝗳 𝗧𝗵𝗲 𝗦𝗼𝗻𝗴 𝗬𝗼𝘂 𝗪𝗮𝗻𝘁... 😍🥰🤗\n\n𝗧𝘆𝗽𝗲 /s 𝗦𝗼𝗻𝗴 𝗡𝗮𝗺𝗲\n\n𝐄𝐠. `/s Faded`'
    message.reply_text(
        text=Mazzakobot, 
        quote=False,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('CONTACT 👬', url='https://t.me/Nezyee'),
                    InlineKeyboardButton('CHECK OUT 🤗', url='https://t.me/ytmp3music_bot?startgroup=true')
                ]
            ]
        )
    )
...
def a(client, message):
    ...
    try:
        ...
        m.edit('❌ 𝐄𝐫𝐫𝐨𝐫\n\n Report This Erorr To Fix @Nezyee ❤️')
        print(e)
    try:
